...
using WanVet.Micro.UserManagement.Read.Domain.Model.UserModel.Consumers;
...
namespace WanVet.Micro.UserManagement.Read
{
    ...
    public class DefaultModule : Autofac.Module
    {
        ...
        {
            cfg.ReceiveEndpoint(host, RabbitMQConstants.UserManagementReadQueue, e =>
            {
                e.Consumer(context.Resolve<IConsumerFactory<UserCreatedEventConsumer>>());
                e.Consumer(context.Resolve<IConsumerFactory<PetCreatedEventConsumer>>());
