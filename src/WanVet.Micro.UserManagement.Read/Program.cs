...
namespace WanVet.Micro.UserManagement.Read
{
    public class Program
    {
        ...
        private const string ServiceName = "WanVet.Micro.UserManagement.Read";
        private const string ServiceDisplayName = "WanVet.Micro.UserManagement.Read";
        private const string ServiceDescription = "WanVet.Micro.UserManagement.Read";
