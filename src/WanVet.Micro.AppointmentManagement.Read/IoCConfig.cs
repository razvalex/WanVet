...
using WanVet.Micro.AppointmentManagement.Read.Domain.Model.AppointmentModel.Consumers;
...
namespace WanVet.Micro.AppointmentManagement.Read
{
    ...
    public class DefaultModule : Autofac.Module
    {
        ...
        {
            cfg.ReceiveEndpoint(host, RabbitMQConstants.AppointmentManagementReadQueue, e =>
            {
