...
namespace WanVet.Micro.UserManagement.Write
{
    public class Program
    {
        ...
        private const string ServiceName = "WanVet.Micro.UserManagement.Write";
        private const string ServiceDisplayName = "WanVet.Micro.UserManagement.Write";
        private const string ServiceDescription = "WanVet.Micro.UserManagement.Write";
