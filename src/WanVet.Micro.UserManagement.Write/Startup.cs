...
using WanVet.Micro.UserManagement.Write.Domain.Model.UserModel.Consumers;
...
namespace WanVet.Micro.UserManagement.Write
{
    internal class Startup
    {
        public void Configure(IApplicationBuilder app)
        {
            ...
            {
                await context.Response.WriteAsync("WanVet.Micro.UserManagement.Write");
            });
        }
        ...
        public class DefaultModule : Autofac.Module
        {
            ...
            {
                cfg.ReceiveEndpoint(host, RabbitMQConstants.UserManagementWriteQueue, e =>
                {
