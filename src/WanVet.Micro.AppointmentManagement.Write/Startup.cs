...
using WanVet.Micro.AppointmentManagement.Write.Domain.Model.AppointmentModel.Consumers;

namespace WanVet.Micro.AppointmentManagement.Write
{
    internal class Startup
    {
        public void Configure(IApplicationBuilder app)
        {
            ...
            {
                await context.Response.WriteAsync("WanVet.Micro.AppointmentManagement.Write");
            });
        }
        ...
        public class DefaultModule : Autofac.Module
        {
            ...
            {
                cfg.ReceiveEndpoint(host, RabbitMQConstants.AppointmentManagementWriteQueue, e =>
                {
                    e.Consumer(context.Resolve<IConsumerFactory<AppointmentDisponibilityConfirmedEventConsumer>>());
                    e.Consumer(context.Resolve<IConsumerFactory<FinalizeAppointmentCommandConsumer>>());                   
                });
            }
        }
    }
