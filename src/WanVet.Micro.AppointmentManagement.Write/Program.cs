...
namespace WanVet.Micro.AppointmentManagement.Write
{
    public class Program
    {
        ...
        private const string ServiceName = "WanVet.Micro.AppointmentManagement.Write";
        private const string ServiceDisplayName = "WanVet.Micro.AppointmentManagement.Write";
        private const string ServiceDescription = "WanVet.Micro.AppointmentManagement.Write";
