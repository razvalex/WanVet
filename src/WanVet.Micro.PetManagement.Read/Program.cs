...
namespace WanVet.Micro.PetManagement.Read
{
    public class Program
    {
        ...
        private const string ServiceName = "WanVet.Micro.PetManagement.Read";
        private const string ServiceDisplayName = "WanVet.Micro.PetManagement.Read";
        private const string ServiceDescription = "WanVet.Micro.PetManagement.Read";
