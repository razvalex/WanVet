...
var iisDevConfig = require('./iis.config.dev');
var iisProdConfig = require('./iis.config.prod');

var publicPath = isDevBuild ? iisDevConfig.publicPath : iisProdConfig.publicPath;
