...
namespace WanVet.Micro.PetManagement.Write
{
    public class Program
    {
        ...
        private const string ServiceName = "WanVet.Micro.PetManagement.Write";
        private const string ServiceDisplayName = "WanVet.Micro.PetManagement.Write";
        private const string ServiceDescription = "WanVet.Micro.PetManagement.Write";
