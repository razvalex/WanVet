...
namespace WanVet.Micro.CalendarManagement.Read
{
    public class Program
    {
        ...
        private const string ServiceName = "WanVet.Micro.CalendarManagement.Read";
        private const string ServiceDisplayName = "WanVet.Micro.CalendarManagement.Read";
        private const string ServiceDescription = "WanVet.Micro.CalendarManagement.Read";
