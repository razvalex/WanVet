...
namespace WanVet.Micro.CalendarManagement.Write
{
    public class Program
    {
        ...
        private const string ServiceName = "WanVet.Micro.CalendarManagement.Write";
        private const string ServiceDisplayName = "WanVet.Micro.CalendarManagement.Write";
        private const string ServiceDescription = "WanVet.Micro.CalendarManagement.Write";
