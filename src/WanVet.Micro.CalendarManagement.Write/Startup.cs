...
using WanVet.Micro.CalendarManagement.Write.Domain.Model.CalendarModel.Consumers;

namespace WanVet.Micro.CalendarManagement.Write
{
    internal class Startup
    {
        public void Configure(IApplicationBuilder app)
        {
            ...
            {
                await context.Response.WriteAsync("WanVet.Micro.CalendarManagement.Write");
            });
        }
        ...
        public class DefaultModule : Autofac.Module
        {
            ...
            {
                cfg.ReceiveEndpoint(host, RabbitMQConstants.CalendarManagementWriteQueue, e =>
                {
                    e.Consumer(context.Resolve<IConsumerFactory<UserCreatedEventConsumer>>());
                    e.Consumer(context.Resolve<IConsumerFactory<RequestAppointmentCommandConsumer>>());
